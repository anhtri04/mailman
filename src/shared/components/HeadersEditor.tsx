...
const HEADER_PRESETS: Record<string, string[]> = {
  ...
  Authorization: ['Bearer <token>', 'Basic <base64-credentials>', 'Digest <credentials>'],
  'X-API-Key': ['<api-key>'],
  'Cache-Control': ['no-cache', 'no-store', 'max-age=0', 'max-age=3600'],
  Cookie: ['session=<value>', 'token=<value>'],
  Origin: ['http://localhost:3000', 'http://localhost:5173', 'https://example.com'],
  Referer: ['http://localhost:3000', 'https://example.com'],
};
