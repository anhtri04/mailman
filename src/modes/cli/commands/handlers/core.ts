  ...
  return [
    {
      ...
      handler: (_args, _ctx) => ({
        message:
          'Commands: /help, /theme, /history, /settings, /collections, /use <id|name>, /header, /body, /params, /query, /variable, /auth, /scripts, /save, /show <body|headers|meta>, /hide <body|headers|meta>, /clear, /exit',
      }),
    },
    {
      name: 'show',
